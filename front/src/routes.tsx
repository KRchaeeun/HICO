...
const routes: RouteType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'childstatus',
        element: React.lazy(
          () => import('@/components/mainparent/ChildStatus')
        ),
      },
    ],
  },
    ...
    children: [
      {
        path: '',
        element: React.lazy(
          () => import('@/components/parentwallet/ParentWallet')
        ),
      },
      {
        path: 'request',
      ...
      },
      {
        path: 'complete',
        element: React.lazy(
          () => import('@/components/parentwallet/SendingComplete')
        ),
      },
    ],
  },
    ...
    children: [
      {
        path: '',
        element: React.lazy(
          () => import('@/components/childwallet/ChildWallet')
        ),
      },
      {
        path: 'point',
      ...
      },
      {
        path: 'askcomplete',
        element: React.lazy(
          () => import('@/components/childwallet/AskComplete')
        ),
      },
      {
        path: 'account',
  ...
  },
  {
    ...
    element: React.lazy(
      () => import('@/components/parentcurrency/CurrencyDetail')
    ),
  },
]
